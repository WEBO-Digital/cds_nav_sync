...
type LEVendorPayment struct {
	...
	AmountLCY               int    `xml:"Amount_LCY" json:"amount_lcy"`
	DebitAmount             int    `xml:"Debit_Amount" json:"debit_amount"`
	CreditAmount            int    `xml:"Credit_Amount" json:"credit_amount"`
	VATAmount               int    `xml:"VAT_Amount" json:"vat_amount"`
	VATDifference           int    `xml:"VAT_Difference" json:"vat_difference"`
	VendorExchangeRateACY   int    `xml:"Vendor_Exchange_Rate_ACY" json:"vendor_exchange_rate_acy"`
	BalVATAmount            int    `xml:"Bal_VAT_Amount" json:"bal_vat_amount"`
	BalVATDifference        int    `xml:"Bal_VAT_Difference" json:"bal_vat_difference"`
	...
	Balance                 int    `xml:"Balance" json:"balance"`
	TotalBalance            int    `xml:"TotalBalance" json:"total_balance"`
}
